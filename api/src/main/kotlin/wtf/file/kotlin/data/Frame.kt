...
interface Frame {
     ...
     * For this every pixel gets transformed into a [wtf.file.kotlin.color.ColorSpace.RGB] pixel}, [wtf.file.kotlin.color.ColorSpace.RGBa]
     * or [wtf.file.kotlin.color.ColorSpace.DynamicRGBa] with a channel width of 8 bits (0-255 values).
